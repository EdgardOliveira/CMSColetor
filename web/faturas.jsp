<%-- 
    Document   : faturas
    Created on : 21/11/2020, 18:02:24
    Author     : Edgard Oliveira
--%>

<%@page import="static utils.Rotinas.*"%>
                    ...
                    <div class="panel-header bg-danger-gradient">
                        <div class="page-inner py-5">
                            <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
                                <div>
                                    <h2 class="text-white pb-2 fw-bold">Faturas</h2>
                                    <h5 class="text-white op-7 mb-2">Consulta de Faturas</h5>
                                </div>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="card-body">
                                        <div class="table-responsive">
                                            <table id="add-row" class="display table table-striped table-hover" >
                                                ...
                                                <tbody>
                                                    <%
                                                        ArrayList<Leituras> listaFaturas = (ArrayList<Leituras>) session.getAttribute("faturas");
                                                        if (listaFaturas != null) {
                                                            //faz mais nada
                                                        } else {
                                                            LeituraDao leituraDao = new LeituraDao();
                                                            listaFaturas = (ArrayList<Leituras>) leituraDao.listar();
                                                        }

                                                        for (Leituras fatura : listaFaturas) {
                                                    %>
                                                    <tr>
                                                        <td><%=fatura.getId()%></td>
                                                        <td><%=formatarMesAno.format(fatura.getMesAno())%></td>
                                                        <td><%=fatura.getConsumo()%></td>
                                                        <td><%=fatura.getTotal()%></td>
                                                        <td>
                                                            <div class="form-button-action">
                                                                <a href="visualizarFatura.jsp?id=<%=fatura.getId()%>" 
                                                                   data-toggle="tooltip" title="" class="btn btn-link btn-primary btn-lg" data-original-title="Visualizar">
                                                                    <i class="fa fa-eye"></i>
                                                                </a>
                                                            </div>
                                                        </td>
