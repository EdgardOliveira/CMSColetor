<%-- 
    Document   : cidades
    Created on : 05/09/2020, 12:17:08
    Author     : Thiago Lins
--%>
                    ...
                    <div class="panel-header bg-warning-gradient">
                        <div class="page-inner py-5">
                            <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
                                <div>
                                    <h2 class="text-white pb-2 fw-bold">Cidades</h2>
                                    <h5 class="text-white op-7 mb-2">Gerenciamento de cidades</h5>
                                </div>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="card-body">
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <p class="small">Cadastre uma cidade</p>
                                                        <form action="CidadeController?operacao=cadastrar" method="POST">                                                       
                                                            <div class="row">
                                                                <div class="form-group">
                                                                    <label for="txtNome">Nome</label>
                                                                    <input type="text" class="form-control" id="txtNome" name="txtNome" maxlength="60" required placeholder="Informe o nome da cidade">
                                        ...
                                        <div class="table-responsive">
                                            <table id="add-row" class="display table table-striped table-hover" >
                                                ...
                                                <tbody>
                                                    <%
                                                        ArrayList<Cidades> listaCidades = (ArrayList<Cidades>) session.getAttribute("cidades");
                                                        if (listaCidades != null) {
                                                            //faz mais nada
                                                        } else {
                                                            CidadeDao cidadeDao = new CidadeDao();
                                                            listaCidades = (ArrayList<Cidades>) cidadeDao.listar();
                                                        }
                                                    ...
                                                    <tr>                                                        
                                                        ...
                                                        <td>
                                                            <div class="form-button-action">
                                                                <a href="alterarCidade.jsp?id=<%=cidade.getId()%>" 
                                                                   data-toggle="tooltip" title="" class="btn btn-link btn-primary btn-lg" data-original-title="Editar">
                                                                    <i class="fa fa-edit"></i>
                                                                </a>

                                                                &nbsp;&nbsp;&nbsp;&nbsp;
                                                                <a href="CidadeController?operacao=excluir&id=<%=cidade.getId()%>" 
